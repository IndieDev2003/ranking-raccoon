...
function CTA() {
  ...
  return (
    <section
      ref={ctaRef}
      className="h-[50vh] sm:h-screen w-full flex justify-center items-center   cta-ref"
    >
      <div className="flex items-center">
        <div className="w-full sm:w-[65vw] h-fit flex flex-col justify-evenly items-start gap-4 sm:gap-10">
          <h2 className="cta-h2 text-3xl sm:text-4xl font-semibold relative">
            <img
              src={crown}
              className="hidden md:block absolute -top-6 -left-8 h-10"
              alt=""
            />
